...
Sub Crea_Tablas_Contable_Maestras()
    ...
    cn.Execute "Generando_Asientos 3,'','',0,'','','','','','','',0,0,'','','','','','',null"
...
Cta_Contable As String, TipBoleta As String, CentroCosto As String, sTipoAsiento As String) As Boolean
'Cta_Contable As String, TipBoleta As String, CentroCosto As String, Area As String, sTipoAsiento As String) As Boolean
    ' MOD GTA - 26/04/2012
    Verifica_Existencia_Registro = False
    s_PlanCont = "Generando_Asientos 6,'','',0,'','" & Cta_Contable & "','" & Mes_Proceso & "'," & _
    "'" & CodEmpresa & "','" & Voucher & "','','" & sTipoAsiento & "',0,0,'" & Año_Proceso & "','" & Semana_Proceso & "'," & _
...
As String, TipoTrabajador As String, CentroCosto As String, Area As String)
    ...
    "'" & Semana_Proceso & "','" & CodTrabajador & "','','" & TipBoleta & "','" & CentroCosto & "','" & Area & "'"
End Sub
...
Cta_Contable As String, TipoBoleta As String, CentroCosto As String, Area As String)
', Tipo As Integer
    'Select Case Tipo
     '   Case 1
            cn.Execute "Generando_Asientos 8,'',''," & Monto & ",'','" & Cta_Contable & "','" & Mes_Proceso & "'," & _
            "'" & CodEmpresa & "','" & Voucher & "','','',0,0,'" & Año_Proceso & "','" & Semana_Proceso & "'," & _
            "'" & CodTrabajador & "','','" & TipoBoleta & "','" & CentroCosto & "','" & Area & "'"
      '  Case 2
...
Año_Proceso As String, Mes_Proceso As String, Semana_Proceso As String, Voucher As String, _
Cta_Contable As String, TipBoleta As String, CentroCosto As String, Area As String)
'            cn.Execute "Generando_Asientos 8,'',''," & Monto & ",'','" & Cta_Contable & "','" & Mes_Proceso & "'," & _
 '           "'" & CodEmpresa & "','" & Voucher & "','','',0,0,'" & Año_Proceso & "','" & Semana_Proceso & "'," & _
  '          "'" & CodTrabajador & "','',''"
    cn.Execute "Generando_Asientos 14,'',''," & Monto & ",'','" & Cta_Contable & "','" & Mes_Proceso & "'," & _
    "'" & CodEmpresa & "','" & Voucher & "','','',0,0,'" & Año_Proceso & "','" & Semana_Proceso & "'," & _
    "'" & CodTrabajador & "','','" & TipBoleta & "','" & CentroCosto & "','" & Area & "'"
End Sub
