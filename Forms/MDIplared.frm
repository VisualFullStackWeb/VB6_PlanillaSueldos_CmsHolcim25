...
Begin VB.MDIForm MDIplared 
   ...
   Begin VB.Menu mnumaestro 
      ...
      Begin VB.Menu mnucia 
         Caption         =   "&Compañias"
      End
      Begin VB.Menu MnuBcoCta 
         Caption         =   "Banco para pago de Haberes"
      End
      ...
      Begin VB.Menu mnuresponsables 
         Caption         =   "Responsables del Personal"
      End
      Begin VB.Menu mnufirmacontrato 
      ...
      Begin VB.Menu SPM2 
         Caption         =   "-"
      End
      Begin VB.Menu mnutrabremotrasemp 
         Caption         =   "Trabajadores con remuneraciones en otras empresas"
      End
   End
   Begin VB.Menu mnuformpara 
      ...
      Begin VB.Menu spferiados 
         Caption         =   "-"
      End
      Begin VB.Menu mnumestopeqta 
         Caption         =   "Mes Tope de Proy de H.Ext. para Qta"
      End
      Begin VB.Menu mnuregfer 
         Caption         =   "Registro de Feriados"
         Visible         =   0   'False
      End
      Begin VB.Menu mnujornalmin 
         Caption         =   "Seteo Jornal Minimo"
      End
      Begin VB.Menu SpComisiones 
         Caption         =   "-"
      End
      Begin VB.Menu MnuCierreComision 
   ...
   Begin VB.Menu mnumov 
      ...
      Tag             =   "M1"
      Begin VB.Menu mnuExcluirAfiliacionPagoSindicato 
         Caption         =   "Excluir Pago Afiliación Sindicato"
      End
      Begin VB.Menu mnuSolicitdSindicato 
         Caption         =   "Solicitud de Sindicato"
      End
      Begin VB.Menu mnuimpmarca 
         Caption         =   "Importar Marcaciones"
      End
      ...
      Begin VB.Menu mnubolmas 
         Caption         =   "Generación de Boletas Masivas"
         Enabled         =   0   'False
         Visible         =   0   'False
      End
      ...
      Begin VB.Menu mnubilletaje 
         ...
         Visible         =   0   'False
      End
      Begin VB.Menu mnuArchBco 
         Caption         =   "Archivo del Banco"
      End
      Begin VB.Menu mnuTelebanking 
         Caption         =   "Archivo de Depositos al Banco"
      End
      Begin VB.Menu MnuCierre 
         Caption         =   "Cierre Planilla"
      End
      Begin VB.Menu mnucalcutilidades 
         Caption         =   "Calculo de Utilidades"
      End
      Begin VB.Menu mnuescolar 
         Caption         =   "Escolaridad"
      End
      Begin VB.Menu spvida 
         Caption         =   "-"
      End
      Begin VB.Menu mnusegvida 
         Caption         =   "Agregar Trabajadores al Seg. Vida Ley"
      End
      Begin VB.Menu spfactura 
         Caption         =   "-"
      End
      Begin VB.Menu mnuFactTercero 
         Caption         =   "Registro de Facturas Terceros"
      End
   End
   Begin VB.Menu mnuconsul 
      ...
      End
      Begin VB.Menu mnusnpessalud 
         Caption         =   "Detalle SNP - ESSALUD"
      End
      ...
      End
      Begin VB.Menu mnuhorasplanta 
         Caption         =   "Horas Planta"
      End
      Begin VB.Menu mnuhistoricos 
         Caption         =   "Otros Reportes"
         Begin VB.Menu mnudeting 
            Caption         =   "Detalle de Ingresos"
         End
         Begin VB.Menu mnuSCTR_GM 
            Caption         =   "Reporte SCTR"
         End
         Begin VB.Menu mnuBase_Rem 
            Caption         =   "Reporte Base Remunerable"
         End
         Begin VB.Menu mnuplamas_plahistorico 
            Caption         =   "Plamas - Plahistorico"
         End
         Begin VB.Menu mnuTabDinam 
            Caption         =   "Tabla Dinámica"
         End
         Begin VB.Menu mnudetbol 
            Caption         =   "Detalle de boletas"
         End
         Begin VB.Menu MnuMarcaciones 
            Caption         =   "Marcaciones"
         End
         Begin VB.Menu mnuTardanza 
            Caption         =   "Tardanzas"
         End
         Begin VB.Menu MnuUltContrato 
            Caption         =   "Ultimos Contratos"
         End
      End
      Begin VB.Menu SPC1 
         Caption         =   "-"
      ...
      Begin VB.Menu MnuCtsFalta 
         Caption         =   "Faltas y Subsidios CTS"
      End
      Begin VB.Menu rpt_plame 
         Caption         =   "Reporte Comacsa Plame"
      End
   End
   ...
   Begin VB.Menu mnuproceso 
      ...
      Begin VB.Menu mnucargapla 
         Caption         =   "Importar Planilla Excel"
      End
      Begin VB.Menu mnuCargaPlaQuin 
         Caption         =   "Importar Quincena Excel"
      End
      Begin VB.Menu mnuimportautilidades 
         Caption         =   "Importar Utilidades"
      End
      Begin VB.Menu mnuImportaAsistencia 
         Caption         =   "Importar Asistencias"
      End
   End
...
'MhState1.Value = True
    Me.Caption = "Versión " & "[ " & App.Major & "." & App.Minor & "." & App.Revision & " ]" & "» Sistema de Planilla" & Space(40) & "Versión " & "[ " & App.Major & "." & App.Minor & "." & App.Revision & " ]"
    Call Setea_StatusBar

TitMsg = "Sistema de Planilla " & "Versión " & "[ " & App.Major & "." & App.Minor & "." & App.Revision & " ]"
...
Private Sub Mnu_Sistema_Click()
Load frmSistemaContable
frmSistemaContable.Show
frmSistemaContable.ZOrder 0
End Sub
...
Private Sub mnuBase_Rem_Click()
    FrmGenAPFNET.TipoReporte = "P"
    Load FrmGenAPFNET
    FrmGenAPFNET.Show
    FrmGenAPFNET.ZOrder 0
End Sub

Private Sub MnuBcoCta_Click()
Load FrmPlaBcoCta
FrmPlaBcoCta.Show
FrmPlaBcoCta.ZOrder 0
End Sub
...
Private Sub mnucalcutilidades_Click()
Load FrmUtilidades
FrmUtilidades.Show
FrmUtilidades.ZOrder 0
End Sub
...
'wTipoDoc = True
'frmCargaPlanilla.Show
'frmCargaPlanilla.ZOrder 0

End Sub

Private Sub mnuCargaPlaQuin_Click()
...
Load FrmCategoriaVendedor
FrmCategoriaVendedor.Show
FrmCategoriaVendedor.ZOrder 0
End Sub
...
Private Sub MnuCierreComision_Click()
Load FrmComisionCierre
FrmComisionCierre.Show
FrmComisionCierre.ZOrder 0
End Sub
...
Private Sub mnudetbol_Click()
Load frmRptDetBoletas
frmRptDetBoletas.Show
frmRptDetBoletas.ZOrder 0
End Sub

Private Sub mnudeting_Click()
FrmRemunerativos.lRepor = "INGRESOS"
FrmRemunerativos.Show
FrmRemunerativos.ZOrder 0
End Sub
...
Private Sub mnuescolar_Click()
Load FrmEscolaridad
FrmEscolaridad.Show
FrmEscolaridad.ZOrder 0
End Sub

Private Sub mnuExcluirAfiliacionPagoSindicato_Click()
Load FrmExcluirPagoSindicato
FrmExcluirPagoSindicato.Show
FrmExcluirPagoSindicato.ZOrder 0
End Sub
...
Private Sub mnuFactTercero_Click()
    Load FrmExamenes
    FrmExamenes.Show
    FrmExamenes.ZOrder 0
End Sub

Private Sub mnufirmacontrato_Click()
Load FrmFirmaContrato
FrmFirmaContrato.Show
FrmFirmaContrato.ZOrder 0
End Sub
...
Private Sub mnuhorasplanta_Click()
    FrmHorasPlanta.Show
    FrmHorasPlanta.ZOrder 0
End Sub
...
Private Sub mnuimpmarca_Click()
Unload FrmImporMarca
Load FrmImporMarca
FrmImporMarca.ZOrder 0
End Sub

Private Sub mnuImportaAsistencia_Click()
    FrmCargaArchivo.Show
    FrmCargaArchivo.ZOrder 0
End Sub

Private Sub mnuimportautilidades_Click()
...
Private Sub mnujornalmin_Click()
Load FrmBasicoMinimo
FrmBasicoMinimo.Show
FrmBasicoMinimo.ZOrder 0
End Sub
...
Private Sub MnuMarcaciones_Click()
Load Frmconsultareodia
Frmconsultareodia.Show
Frmconsultareodia.lRepor = "MARCA"
Frmconsultareodia.FrameGenera.Visible = True
Frmconsultareodia.ZOrder 0
End Sub

Private Sub mnumestopeqta_Click()
Dim Vmes As String
Dim lMesNom As String
Dim Rq As ADODB.Recordset
lMesNom = ""
Sql = "Select Mes_Tope From Pla_Qta_Mes_Tope_Proyecc where cia='01' and Status<>'*'"
If fAbrRst(Rq, Sql) Then
   Select Case Rq(0)
      Case 0: lMesNom = "No Se Proyecta"
      Case Else: lMesNom = Name_Month(Format(Rq(0), "00"))
   End Select
Else
   lMesNom = "No Se Proyecta"
End If
Rq.Close: Set Rq = Nothing

Vmes = InputBox("Ingrese el Número de mes hasta donde se proyectaran Horas Extras y otros Ingresos para calculo de Quinta Categoria" & Chr(13) & "Actualmente es " & lMesNom, "Reporte Nuevo")
If Not IsNumeric(Vmes) Then
   MsgBox "Tiene que indicar un número del 0 al 12" & Chr(13) & "No se Registro la operación", vbInformation
    Exit Sub
End If
If Val(Vmes) <> CInt(Val(Vmes)) Then
   MsgBox "Tiene que indicar un número del 0 al 12" & Chr(13) & "No se Registro la operación", vbInformation
   Exit Sub
End If
If Val(Vmes) < 0 Or Val(Vmes) > 12 Then
   MsgBox "Tiene que indicar un número del 0 al 12" & Chr(13) & "No se Registro la operación", vbInformation
   Exit Sub
End If
Sql = "Update Pla_Qta_Mes_Tope_Proyecc Set status='*',user_modi='" & wuser & "',fec_modi=getdate() where cia='" & wcia & "' and status<>'*' "
Sql = Sql & " Insert Into Pla_Qta_Mes_Tope_Proyecc values('" & wcia & "'," & Vmes & ",'" & wuser & "',getdate(),'" & wuser & "',getdate(),'')"
cn.Execute Sql, 64
...
Private Sub mnuSCTR_GM_Click()
    FrmGenAPFNET.TipoReporte = "S"
    Load FrmGenAPFNET
    FrmGenAPFNET.Show
    FrmGenAPFNET.ZOrder 0
End Sub
...
Private Sub mnusegvida_Click()
Load FrmAgregaSegVida
FrmAgregaSegVida.Show
FrmAgregaSegVida.ZOrder 0
End Sub
...
Private Sub mnusnpessalud_Click()
NameForm = "SNPESSALUD"
Load Frmmes
Frmmes.Show
Frmmes.ZOrder 0
...
Private Sub mnuSolicitdSindicato_Click()
Load FrmSolicitudSindicato
FrmSolicitudSindicato.Show
FrmSolicitudSindicato.ZOrder 0
...
Private Sub mnuTardanza_Click()
Load Frmconsultareodia
Frmconsultareodia.Show
Frmconsultareodia.lRepor = "TARDA"
Frmconsultareodia.FrameGenera.Visible = True
Frmconsultareodia.ZOrder 0
End Sub
...
Private Sub mnuTelebanking_Click()

Load FrmTelebankingGroup
FrmTelebankingGroup.Show
FrmTelebankingGroup.ZOrder 0
End Sub

Private Sub mnutrabremotrasemp_Click()
Load FrmTrabRemOtrasEmp
FrmTrabRemOtrasEmp.Show
FrmTrabRemOtrasEmp.ZOrder 0
End Sub
...
Private Sub MnuVendComision_Click()
Load FrmComisionVendedor
FrmComisionVendedor.Show
FrmComisionVendedor.ZOrder 0
End Sub
...
Private Sub rpt_plame_Click()
Load FrmRptPlame
FrmRptPlame.Show
FrmRptPlame.ZOrder 0
End Sub
...
Case Is = 10
     If DoEvents > 1 Then
        ...
        End If
     Else
        If MsgBox("Desea Salir Del Sistema", vbYesNo + vbQuestion) = vbYes Then Unload MDIplared: End
     End If
Case Is = 1
     If DoEvents > 1 Then
        ...
        Case Is = "FrmExamenes"
            FrmExamenes.Nuevo
        Case Is = "FrmTelebanking"
            FrmTelebanking.Nuevo
        Case Is = "FrmTelebankingGroup"
            FrmTelebanking.Nuevo
        Case Is = "aFrmDH"
             aFrmDH.NuevoTrab
        ...
        Case Is = "FrmCtaCte"
             Frmplacte.lCod = FrmCtaCte.LblCodTrab.Caption
             Frmplacte.Nuevo_Prestamo
        Case Is = "Frmboleta"
        ...
        Case Is = "FrmCtsFalta"
             FrmCtsFalta.Nuevo_Registro (True)
        Case Is = "FrmTrabRemOtrasEmp"
             If FrmTrabRemOtrasEmp.SStabOtras.Caption = "Trabajadores con otrasremunerciones" Then
                FrmTrabRemOtrasEmp.Nuevo_Trabajador_Otras
             End If
             If FrmTrabRemOtrasEmp.SStabOtras.Caption = "Otras empresas" Then
                FrmTrabRemOtrasEmp.Nueva_Empresa
             End If
             If FrmTrabRemOtrasEmp.SStabOtras.Caption = "Remuneraciones otras empresas" Then
                FrmTrabRemOtrasEmp.Nueva_Remuneracion
             End If
     ...
     If DoEvents > 1 Then
        Select Case MDIplared.ActiveForm.Name
               Case Is = "FrmExamenes"
                    FrmExamenes.Grabar
               Case Is = "FrmTelebanking"
                    FrmTelebanking.Grabar
               Case Is = "FrmSolicitudSindicato"
                    FrmSolicitudSindicato.Grabar
               Case Is = "frmSistemaContable"
                    frmSistemaContable.Grabar_Sistema
               Case Is = "aFrmDH"
                    aFrmDH.Grabar
               Case Is = "FrmDiasNoTrab"
                    FrmDiasNoTrab.Grabar
               Case Is = "FrmComisionVendedor"
                    FrmComisionVendedor.Grabar
               Case Is = "FrmDiasSub"
                    FrmDiasSub.Grabar
               Case Is = "FrmGrdPersonal"
               ...
               Case Is = "FrmMContAsoc"
                ...
                Case Is = "FrmCategoriaVendedor"
                    FrmCategoriaVendedor.Graba_Categoria
                Case Is = "FrmPlaBcoCta"
                    FrmPlaBcoCta.Graba_BcoCta
        End Select
     End If
Case Is = 3     'ELIMINAR
     If DoEvents > 1 Then
        Select Case MDIplared.ActiveForm.Name
        Case Is = "FrmExamenes"
             FrmExamenes.Eliminar
        Case Is = "FrmAgregaSegVida"
             FrmAgregaSegVida.Elimina_Persona
        Case Is = "FrmSolicitudSindicato"
             FrmSolicitudSindicato.Eliminar
        
        Case Is = "frmcontratos"
            frmcontratos.Eliminar_Contrato
        ...
        Case "FrmTrabRemOtrasEmp"
             If FrmTrabRemOtrasEmp.SStabOtras.Caption = "Trabajadores con otrasremunerciones" Then
                FrmTrabRemOtrasEmp.Anula_Trabajador_Otras
             End If
             If FrmTrabRemOtrasEmp.SStabOtras.Caption = "Otras empresas" Then
                FrmTrabRemOtrasEmp.Anula_Empresa_Otras
             End If
        End Select
     End If
Case Is = 5  'BUSCAR
     If DoEvents > 1 Then
        ...
        Case Is = "FrmPromedios"
         If FrmPromedios.TxtCodTrabajador.Enabled = True Then
            Load Frmgrdpla
            Frmgrdpla.Visible = True
            Frmgrdpla.ZOrder 0
         End If
        ...
        Case Is = "Frmprovision"
          If Frmprovision.FramePerdidas.Visible = True Then
                Load Frmgrdpla
                Frmgrdpla.Visible = True
                Frmgrdpla.ZOrder 0
             End If
...
Case Is = 8
     If DoEvents > 1 Then
        Select Case MDIplared.ActiveForm.Name
        Case Is = "FrmTelebanking"
            FrmTelebanking.Procesar_Boletas
        Case Is = "FrmRepafp"
