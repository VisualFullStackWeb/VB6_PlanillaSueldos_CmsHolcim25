...
Begin VB.Form FrmResponsables 
   ...
   Caption         =   "» Mantenimientos de Responsables «"
   ClientHeight    =   5430
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7830
   Icon            =   "FrmResponsables.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frm_00 
      ...
      Begin MSForms.CommandButton btn_salir 
         ...
         Size            =   "635;661"
         Picture         =   "FrmResponsables.frx":030A
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton btn_eliminar 
         ...
         PicturePosition =   262148
         Size            =   "635;661"
         Picture         =   "FrmResponsables.frx":08A4
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
      ...
      Begin MSForms.CommandButton btn_editar 
         ...
         PicturePosition =   262148
         Size            =   "635;661"
         Picture         =   "FrmResponsables.frx":0E3E
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
      ...
      Begin MSForms.CommandButton btn_aceptar 
         ...
         PicturePosition =   262148
         Size            =   "635;661"
         Picture         =   "FrmResponsables.frx":13D8
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
      ...
      Begin MSForms.CommandButton btn_nuevo 
         ...
         PicturePosition =   262148
         Size            =   "635;661"
         Picture         =   "FrmResponsables.frx":1972
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
...
Private Sub Trae_Info()
    Cadena = "SP_TRAE_CARGOS_CIA '" & wcia & "','087'"
...
Public Sub Aceptar(Optional ByVal Eliminar As Boolean = False)
    Cadena = "SP_MANT_CARGO '" & wcia & "', '" & txt_cod.Text & "', '" & txt_descrip.Text & "', '', '" & wuser & "', " & CInt(Eliminar) & ",'087'"
