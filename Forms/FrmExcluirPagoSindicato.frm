...
Begin VB.Form FrmExcluirPagoSindicato 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Excluir Pago de Sindicato"
   ClientHeight    =   6735
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9885
   Icon            =   "FrmExcluirPagoSindicato.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Cmbtipotrabajador 
         Height          =   315
         ItemData        =   "FrmExcluirPagoSindicato.frx":030A
         Left            =   7320
         List            =   "FrmExcluirPagoSindicato.frx":030C
   ...
   Begin TrueOleDBGrid70.TDBGrid GrdSolicitud 
      ...
      Splits(0)._ColumnProps(13)=   "Column(2).Width=12515"
      Splits(0)._ColumnProps(14)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(15)=   "Column(2)._WidthInPix=12435"
   ...
   End
End
Attribute VB_Name = "FrmExcluirPagoSindicato"
...
Sql$ = Sql$ & "'," & Year(Cmbfecha.Value) & ",'" & IIf(VTipotrab = "02", Format(Trim(Me.Txtsemana.Text), "00"), "") & "','" & Format(Cmbfecha.Value, "mm/dd/yyyy")
Sql$ = Sql$ & "','S/.',0,'','" & wuser & "',"
